        ...
        <div className="flex min-h-[500px] w-full flex-col items-center justify-center rounded-lg border border-border bg-neutral-950 p-8 text-center text-foreground">
          <div className="flex max-w-md flex-col items-center">
            ...
            <p className="mt-2 text-sm text-neutral-400 leading-relaxed">
              This panel encountered a runtime exception. You can attempt to reload the component or
              refresh the screen.
            </p>
            ...
            <Button className="mt-6 font-medium" onClick={this.handleReload} variant="outline">
              Reload Application
            </Button>
          </div>
        </div>
